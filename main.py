...
if __name__ == '__main__':
	chars = list(
		"あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをんがぎぐげござじずぜぞだぢづでどばびぶべぼぱぴぷぺぽアイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヲンガギグゲゴザジズゼゾダヂヅデドバビブベボパピプペポぁぃぅぇょぉゅゃヵヶっァィゥェォョャッュ、。！？1234567890＃満❤ー・…/￥」「｜＝(),.;:草[]-←→↑↓")
	ending_chars = list("。！？❤」｜)]")
	starting_chars = list("＃「｜([")
	emoji_chars = list("ℹ�")
